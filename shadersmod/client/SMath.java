...
/* 10 */     for (int co = 0; co < 4; co++) {
/*    */       
/* 12 */       for (int ro = 0; ro < 4; ro++)
/*    */       {
/* 14 */         matOut[4 * co + ro] = matA[4 * co + 0] * matB[0 + ro] + matA[4 * co + 1] * matB[4 + ro] + matA[4 * co + 2] * matB[8 + ro] + matA[4 * co + 3] * matB[12 + ro];
/*    */       }
/*    */     } 
/*    */   }
/*    */ 
...
/* 45 */     float det = m[0] * matOut[0] + m[1] * matOut[4] + m[2] * matOut[8] + m[3] * matOut[12];
/*    */     
/* 47 */     if (det != 0.0D) {
/*    */       
/* 49 */       for (int i = 0; i < 16; i++)
/*    */       {
/* 51 */         matOut[i] = matOut[i] / det;
/*    */       }
/*    */     }
/*    */     else {
/*    */       
...
/* Location:              C:\Users\wyatt\Downloads\Leap-Client.jar!\shadersmod\client\SMath.class
