...
public interface INetHandlerPlayClient extends INetHandler {
  ...
  void func_175098_a(S42PacketCombatEvent paramS42PacketCombatEvent);
  
  void func_175101_a(S41PacketServerDifficulty paramS41PacketServerDifficulty);
  
  void func_175094_a(S43PacketCamera paramS43PacketCamera);
  
  void func_175093_a(S44PacketWorldBorder paramS44PacketWorldBorder);
  
  void func_175099_a(S45PacketTitle paramS45PacketTitle);
  
  void func_175100_a(S46PacketSetCompressionLevel paramS46PacketSetCompressionLevel);
  
  void func_175096_a(S47PacketPlayerListHeaderFooter paramS47PacketPlayerListHeaderFooter);
  
  void func_175095_a(S48PacketResourcePackSend paramS48PacketResourcePackSend);
  
  void func_175097_a(S49PacketUpdateEntityNBT paramS49PacketUpdateEntityNBT);
}
